...
export default function JobsPage() {
  ...
  if (sortBy === "match") jobs.sort((a, b) => b.scores.composite - a.scores.composite);
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 flex items-center gap-2">
                      <ScoreChip label="Skills" score={job.scores.skills} />
                      <ScoreChip label="Culture" score={job.scores.culture} />
                      <ScoreChip label="Career" score={job.scores.trajectory} />
                      <span className="ml-1 text-sm font-bold text-[var(--color-text-primary)]">
                        Overall: {job.scores.composite}%
                      </span>
                    </div>
